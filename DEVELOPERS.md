...
By default screenshots are not generated unless you set the `TAKE_SCREENSHOTS` environment variable to `True` - either in your `.env` file or by executing the tests like:
