...
import type { DRAFT_URL } from "../../types";
      ...
      <div className="list-group list-group-flush">
        ...
        {counts["?"] > 0 && (
          <a
            className={`
              list-group-item list-group-item-action
              ${currentFilter === "unresolved" ? "active" : ""}
            `}
        ...
        {counts["!"] > 0 && (
          <a
            className={`
              list-group-item list-group-item-action
              ${currentFilter === "in-conflict" ? "active" : ""}
            `}
        ...
        {currentFilter ? (
          <a
            className={`
              font-italic list-group-item list-group-item-action
              ${currentFilter === "in-conflict" ? "active" : ""}
            `}
