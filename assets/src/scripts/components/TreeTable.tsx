    ...
    <>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            Exclude codes in <strong>Body Structure</strong>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div>
            ...
            <p>
              ...
              <strong className="text-primary"> included</strong> and will now
              be <strong className="text-info">excluded</strong> instead:
            </p>
            <ul>
              <li>
          ...
          <div>
            ...
            <p>
              The following 2 codes within <strong>Body Structure</strong> are
              already <strong className="text-info">excluded</strong> and will
              not be updated:
            </p>
            <ul>
              <li>
