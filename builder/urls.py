...
urlpatterns = [
    ...
    path("<hash>/api/description", views.description, name="api-description"),
    path("<hash>/api/methodology", views.methodology, name="api-methodology"),
    path("<hash>/api/references", views.references, name="api-references"),
