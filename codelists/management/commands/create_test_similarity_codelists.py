    ...
    def _generate_code_combinations(self):
        ...
        for i in range(15):
            ...
            combinations_list.append((
                codes,
                f"High similarity variant {i+1} - primarily elbow conditions"
            ))
        ...
        for i in range(12):
            ...
            combinations_list.append((
                codes,
                f"Medium similarity {i+1} - balanced joint conditions"
            ))

        # 4. Low similarity (20-40%) - mostly extended codes
        for i in range(11):
            core_count = random.randint(0, 2)  # Very few core codes
            core_subset = random.sample(self.CORE_ELBOW_CODES, core_count) if core_count > 0 else []
            ...
            combinations_list.append((
                codes,
                f"Low similarity {i+1} - mostly non-elbow conditions"
            ))
