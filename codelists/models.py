...
class CodelistVersion(models.Model):
    ...
    def get_builder_search_url(self, search_id):
        return reverse("builder:search", args=[self.hash, search_id])

    def get_builder_delete_search_url(self, search_id):
        return reverse("builder:delete-search", args=[self.hash, search_id])
