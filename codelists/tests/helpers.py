...
def hierarchies(draw, size):
    ...
    Based on an idea by @Zac-HD at https://github.com/HypothesisWorks/hypothesis/issues/2464.
    """
...
class MockCodingSystem(DummyCodingSystem):
    ...
    Ancestor and descendant relationships are built by walking up and down the
