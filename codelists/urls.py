...
for subpath, view in [
    ...
    ("<codelist_slug>/<tag>/", views.version),
    ("<codelist_slug>/<tag>/update/", views.version_update),
    ("<codelist_slug>/<tag>/publish/", views.version_publish),
    ("<codelist_slug>/<tag>/download.csv", views.version_download),
]:
    urlpatterns.append(
        path(
