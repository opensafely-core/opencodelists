...
class VTM(models.Model):
    ...
    id = models.CharField(
        primary_key=True, max_length=18, db_column="vtmid", help_text="Identifier"
    )
    ...
    vtmidprev = models.CharField(
        null=True, max_length=18, help_text="Previous identifier"
    )
...
class VMP(models.Model):
    ...
    id = models.CharField(
        primary_key=True, max_length=18, db_column="vpid", help_text="Identifier"
    )
    vpiddt = models.DateField(null=True, help_text="Date identifier became valid")
    vpidprev = models.CharField(
        null=True, max_length=18, help_text="Previous product identifier"
    )
...
class VPI(models.Model):
    ...
    bs_subid = models.CharField(
        null=True, max_length=18, help_text="Basis of strength substance identifier"
    )
...
class AMP(models.Model):
    ...
    id = models.CharField(
        primary_key=True, max_length=18, db_column="apid", help_text="Identifier"
    )
    invalid = models.BooleanField(help_text="Invalid")
    vmp = models.ForeignKey(
        db_column="vpid", to="VMP", on_delete=models.CASCADE, help_text="VMP"
...
class VMPP(models.Model):
    ...
    id = models.CharField(
        primary_key=True, max_length=18, db_column="vppid", help_text="Identifier"
    )
    invalid = models.BooleanField(help_text="Invalid")
...
class AMPP(models.Model):
    ...
    id = models.CharField(
        primary_key=True, max_length=18, db_column="appid", help_text="Identifier"
    )
    invalid = models.BooleanField(help_text="Invalid")
...
class Ing(models.Model):
    ...
    id = models.CharField(
        primary_key=True, max_length=18, db_column="isid", help_text="Identifier"
    )
    isiddt = models.DateField(null=True, help_text="Date identifier became valid")
    isidprev = models.CharField(
        null=True, max_length=18, help_text="Previous identifier"
    )
    invalid = models.BooleanField(help_text="Invalid")
    nm = models.CharField(max_length=255, help_text="Name")
...
class UnitOfMeasure(models.Model):
    cd = models.CharField(primary_key=True, max_length=18, help_text="Code")
    cddt = models.DateField(null=True, help_text="Date code is applicable from")
    cdprev = models.CharField(null=True, max_length=18, help_text="Previous code")
    descr = models.CharField(max_length=150, help_text="Description")
