...
def build_2016_claml_scraped_diff_report(
    ...
    for code in codes_in_both:
        claml_description = description_with_modifier(claml_records[code])
        scraped_description = description_with_modifier(scraped_records[code])
...
def _merge_2016_claml_and_scraped_records(
    ...
    for code in sorted(set(claml_2016_records) | set(scraped_2016_records)):
        ...
        claml_description = description_with_modifier(claml_record)
        scraped_description = description_with_modifier(scraped_record)
        if claml_description == scraped_description:
            combined[code] = scraped_record
            continue
...
def build_2016_2019_diff_report(
    ...
    for code in codes_in_both:
        combined_2016_description = description_with_modifier(
            combined_2016_records[code]
        )
        who_2019_description = description_with_modifier(who_2019_records[code])
