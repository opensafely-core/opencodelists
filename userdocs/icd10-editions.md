...
* the [NHS-modified 2016 edition](https://classbrowser.nhs.uk/#/book/ICD-10-5TH-Edition) used in [HES/APCS hospital admissions data](https://docs.opensafely.org/data-sources/apc/); and
* the [WHO 2019 edition](https://icd.who.int/browse10/2019/en) used in [ONS deaths data](https://docs.opensafely.org/data-sources/onsdeaths/).

### Why have you combined the two editions?

Most ICD-10 codes have the same meaning in both editions. Codelists are also
often used with more than one dataset. Asking people to choose an edition
...
OpenCodelists therefore provides a single ICD-10 coding system containing codes
